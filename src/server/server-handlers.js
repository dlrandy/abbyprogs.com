...
import * as booksDB from '@app/server/data/books'
import * as usersDB from '@app/server/data/users'
import * as listItemsDB from '@app/server/data/list-items'

let sleep
if (import.meta.env.VITE_CI) {
  sleep = () => Promise.resolve()
} else if (import.meta.env.VITE_TEST) {
  sleep = () => Promise.resolve()
} else {
  sleep = (
